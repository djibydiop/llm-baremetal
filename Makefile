...
# Compile drc_core.c
drc_core.o: drc_core.c drc_core.h
	$(CC) $(CFLAGS) -msse2 -c drc_core.c -o drc_core.o
...
llama2.so: $(LLAMA2_OBJ) network_boot.o wifi_ax200.o wifi_firmware.o drc_core.o
	ld $(LDFLAGS) $(LLAMA2_OBJ) network_boot.o wifi_ax200.o wifi_firmware.o drc_core.o -o llama2.so $(LIBS)
...
clean:
	rm -f $(LLAMA2_OBJ) network_boot.o wifi_ax200.o wifi_firmware.o drc_core.o llama2.so $(LLAMA2)
